...
class CalcRespCorrDiJets : public edm::EDAnalyzer {
 ...
 private:
  ...
  float tpfjet_chHad_E_, tpfjet_chHad_px_, tpfjet_chHad_py_, tpfjet_chHad_pz_, tpfjet_chHad_EcalE_;
  ...
  float tpfjet_Had0_E_, tpfjet_Had0_px_, tpfjet_Had0_py_, tpfjet_Had0_pz_, tpfjet_Had0_EcalE_;
  float tpfjet_HFHad_E_, tpfjet_HFHad_px_, tpfjet_HFHad_py_, tpfjet_HFHad_pz_, tpfjet_HFHad_EcalE_;
  float tpfjet_HFEM_E_, tpfjet_HFEM_px_, tpfjet_HFEM_py_, tpfjet_HFEM_pz_, tpfjet_HFEM_EcalE_;
  ...
  int tpfjet_ntwrs_;
  int tpfjet_twr_ieta_[1000], tpfjet_twr_candtrackind_[1000];
  float tpfjet_twr_eme_[1000], tpfjet_twr_hade_[1000], tpfjet_twr_frac_[1000];
  int tpfjet_ncandtracks_;
  float tpfjet_candtrack_p_[1000], tpfjet_candtrack_EcalE_[1000];
  ...
  float ppfjet_chHad_E_, ppfjet_chHad_px_, ppfjet_chHad_py_, ppfjet_chHad_pz_, ppfjet_chHad_EcalE_;
  ...
  float ppfjet_Had0_E_, ppfjet_Had0_px_, ppfjet_Had0_py_, ppfjet_Had0_pz_, ppfjet_Had0_EcalE_;
  float ppfjet_HFHad_E_, ppfjet_HFHad_px_, ppfjet_HFHad_py_, ppfjet_HFHad_pz_, ppfjet_HFHad_EcalE_;
  float ppfjet_HFEM_E_, ppfjet_HFEM_px_, ppfjet_HFEM_py_, ppfjet_HFEM_pz_, ppfjet_HFEM_EcalE_;
  ...
  int ppfjet_ntwrs_;
  int ppfjet_twr_ieta_[1000], ppfjet_twr_candtrackind_[1000];
  float ppfjet_twr_eme_[1000], ppfjet_twr_hade_[1000], ppfjet_twr_frac_[1000];
  int ppfjet_ncandtracks_;
  float ppfjet_candtrack_p_[1000], ppfjet_candtrack_EcalE_[1000];
