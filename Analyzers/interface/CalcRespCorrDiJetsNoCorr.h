#ifndef _HCALCLOSURETEST_ANALYZERS_CALCRESPCORRDIJETSNOCORR_H_
#define _HCALCLOSURETEST_ANALYZERS_CALCRESPCORRDIJETSNOCORR_H_

//
// CalcRespCorrDiJetsNoCorr.h
//
...
class CalcRespCorrDiJetsNoCorr : public edm::EDAnalyzer {
 public:
  explicit CalcRespCorrDiJetsNoCorr(const edm::ParameterSet&);
  ~CalcRespCorrDiJetsNoCorr();
