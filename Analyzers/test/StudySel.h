...
// Thu Dec 18 19:09:49 2014 by ROOT version 5.34/21
// from TTree pf_gammajettree/tree for gamma+jet balancing using PFJets
// found on file: LvdpSele.root
//////////////////////////////////////////////////////////
...
public :
   ...
   virtual Double_t calc_effSigma(TH1* h);
   virtual void     Use2ndJetPt(double& jetEt, double& gamPt);
};

#endif

#ifdef StudySel_cxx
StudySel::StudySel(TTree *tree) : fChain(0) 
{
...
Int_t StudySel::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StudySel::LoadTree(Long64_t entry)
{
...
void StudySel::Show(Long64_t entry)
{
...
Int_t StudySel::Cut(Long64_t entry)
{
